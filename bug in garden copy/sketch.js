...
function setup(){
    ...
    worm = new SCWorm(random(width), random(height), random(-10, 10), random(-10, 10));

    
    wormArr = new Array(400);
    ...
    for (let i = 0; i < wormArr.length; i++){
        ...
        wormArr[i] = new SCWorm(lx,ly,rot,sc,speedX,speedY);
    }
